...
export class WineListComponent implements OnInit {
 private wineList: wines[] = [];
  ...
  constructor() { 
    for(let winesObj of WINES){
      this.wineList.push(new wines(winesObj));
    }
  }
